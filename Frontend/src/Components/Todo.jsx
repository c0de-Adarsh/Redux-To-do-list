...
export const Todo = ({ num, title, desc, id }) => {
    ...
    const update = (e) => {
        ...
        // Creating data to be sent to the backend
        const data = {
            title: newTitle,  // Title being updated
            desc: newDesc     // Description being updated
        };

        // Logging the data to check if it's correct
        console.log("Payload being sent:", data);  // Log to see what data is being sent

        // Dispatch the action to update todo
